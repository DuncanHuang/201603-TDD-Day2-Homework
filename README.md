...
雖然 Production Code 好了之後，2 ~ 7 的測試案例都直接綠燈

但在第一個測試案列出來後要寫 Production Code 時，卻一直考慮很多，花了一、兩個小時

如果單以第一個測試案列的角度來看的話，想這麼多好像有點 Over Design

我想應該是還不習慣以測試案例的角度來寫 Production Code
